...
Just like with all other XOR containers, all iterators, but not references nor pointers are invalidated after inserting or erasing from an XOR linked list.
